...
export async function GET() {
  ...
  const envCheck = {
    NS_ACCOUNT_ID: true,
    NS_CONSUMER_KEY: `${CONSUMER_KEY.slice(0, 6)}...`,
    NS_CONSUMER_SECRET: `${CONSUMER_SECRET.slice(0, 6)}...`,
    NS_TOKEN_ID: `${TOKEN_ID.slice(0, 6)}...`,
    NS_TOKEN_SECRET: `${TOKEN_SECRET.slice(0, 6)}...`,
  }
